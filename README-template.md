...
- Solution URL: [Check out the code here](https://github.com/TheCoderGuru/github-user-search-app)
- Live Site URL: [Visit the live site here](http://github-user-search-app-alpha.vercel.app/)
